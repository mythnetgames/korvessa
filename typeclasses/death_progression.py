...
def _play_permanent_death(account, character, session):
    ...
    delay(1.5, account.msg, "|#5f005fYou release your grip on the mortal world.|n")
    delay(3.0, account.msg, "")
    delay(4.0, account.msg, "|#5f005fThe breath leaves your body.|n")
    delay(5.5, account.msg, "|#5f0087The pain becomes memory becomes nothing.|n")
    delay(7.0, account.msg, "|#5f00afEverything... dissolves...|n")
    delay(9.0, account.msg, "")
    delay(10.5, account.msg, "|#5f00d7Darkness wraps around you, soft and inevitable.|n")
    delay(12.5, account.msg, "")
    delay(14.0, account.msg, "|#5f00d7No light. No sound. No self.|n")
    delay(16.0, account.msg, "")
    delay(18.0, account.msg, "|#5f00ffOnly the vast, knowing silence.|n")
    delay(20.0, account.msg, "")
    delay(22.0, account.msg, "|m" + "=" * 70 + "|n")
    delay(24.0, account.msg, "")
    delay(26.0, account.msg, "|#af00ff    And then...|n")
