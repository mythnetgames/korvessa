...
# Typing messages
MSG_TYPING_START_SELF = "You start typing on your {device_name}."
MSG_TYPING_START_ROOM = "{char_name} starts typing on their {device_name}."
MSG_TYPING_DONE_SELF = "You send a message on your {device_name}."
MSG_TYPING_DONE_ROOM = "{char_name} looks up from their {device_name}."
MSG_TYPING_CANCELLED_SELF = "You stop typing and put away your {device_name}."
