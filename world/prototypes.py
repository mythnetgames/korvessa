...
# Ranged weapons locker (bows, crossbows, throwing weapons)
RANGED_WEAPONS_LOCKER = {
    "prototype_parent": "shop_container_base",
    "key": "weapons locker",
    "desc": "A secure weapons locker with reinforced construction. Contains various ranged weapons under lock and key.",
    "attrs": [
        ("shop_name", "Weapons Shop"),
        ("container_type", "locker"),
        ("markup_percent", 20),  # 20% markup on weapons
        ("prototype_inventory", {
            "THROWING_KNIFE": 40,
            "THROWING_AXE": 60,
            "SHURIKEN": 25,
